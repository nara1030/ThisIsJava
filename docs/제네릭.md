...
<img src="../img/generic_qna_1.png" width="450" height="650"></br>
	* 따라서 와일드카입이 제네릭의 해결책이 아니다.  
* 차이점: 제한된 타입 파라미터와 와일드 카드  
<img src="../img/generic_qna_2.png" width="450" height="350"></br>
	* 제한된 타입 파라미터: 제네릭 타입을 개발할 때 타입 파라미터를 제한할 목적
	* 와일드 카드: 이미 개발된 제네릭 타입을 매개 변수 타입이나 리턴 타입으로 사용할 때 타입 파라미터를 제한할 목적
* 기타
	* `<? super E>`  
	<img src="../img/generic_qna_3.png" width="450" height="300"></br>
	* `List<?> list = new ArrayList<>();`  
	<img src="../img/generic_qna_4.png" width="450" height="250"></br>
